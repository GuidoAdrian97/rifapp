...
class Raffle extends Model
{
    ...
    protected $fillable = ['title','description','cantidad_boletos','rango_inicial_boletos','rango_final_boletos','costo_bololeto','fecha_sorteo_rifa','estado','metodo_sorteo_id'];
