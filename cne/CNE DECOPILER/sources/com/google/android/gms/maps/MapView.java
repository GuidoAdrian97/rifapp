...
public class MapView extends FrameLayout {
    ...
    final class zza implements LifecycleDelegate {
    ...
    final class zzb extends DeferredLifecycleHelper {
        private OnDelegateCreatedListener zzbd;
        private final List zzbf = new ArrayList();
