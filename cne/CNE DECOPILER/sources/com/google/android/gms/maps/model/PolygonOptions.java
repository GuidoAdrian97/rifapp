...
public final class PolygonOptions extends AbstractSafeParcelable {
    ...
    PolygonOptions(List list, List list2, float f, int i, int i2, float f2, boolean z, boolean z2, boolean z3, int i3, @Nullable List list3) {
        this.zzdx = list;
        this.zzdy = list2;
        this.zzcr = f;
        this.strokeColor = i;
    ...
    public final PolygonOptions strokePattern(@Nullable List list) {
        this.zzcv = list;
        return this;
    }
