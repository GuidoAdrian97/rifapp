...
public final class PolylineOptions extends AbstractSafeParcelable {
    ...
    PolylineOptions(List list, float f, int i, float f2, boolean z, boolean z2, boolean z3, @Nullable Cap cap, @Nullable Cap cap2, int i2, @Nullable List list2) {
        this.width = 10.0f;
        this.color = -16777216;
        this.zzcs = 0.0f;
        this.zzct = true;
    ...
    public final PolylineOptions pattern(@Nullable List list) {
        this.zzef = list;
        return this;
    }
