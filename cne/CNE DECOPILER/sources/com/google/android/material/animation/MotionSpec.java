...
public class MotionSpec {
    ...
    @NonNull
    public ObjectAnimator getAnimator(@NonNull String str, @NonNull Object obj, @NonNull Property property) {
    ...
    @NonNull
    private static MotionSpec createSpecFromAnimators(@NonNull List list) {
