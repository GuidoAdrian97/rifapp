...
public final class CollapsingTextHelper {
    ...
    private float calculateFadeModeTextAlpha(@FloatRange float f) {
    ...
    private void calculateUsingTextSize(float f) {
        calculateUsingTextSize(f, DEBUG_DRAW);
    }
    ...
    private void calculateUsingTextSize(float f, boolean z) {
        ...
        if (this.text != null) {
            ...
            boolean isClose = isClose(f, this.collapsedTextSize);
            boolean z4 = DEBUG_DRAW;
            int i = 1;
            if (isClose) {
