...
abstract class MaterialVisibility extends Visibility {
    ...
    protected MaterialVisibility(VisibilityAnimatorProvider visibilityAnimatorProvider, @Nullable VisibilityAnimatorProvider visibilityAnimatorProvider2) {
    ...
    private static void addAnimatorIfNeeded(List list, @Nullable VisibilityAnimatorProvider visibilityAnimatorProvider, ViewGroup viewGroup, View view, boolean z) {
        Animator animator;
