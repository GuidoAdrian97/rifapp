...
public final class MaterialContainerTransform extends Transition {
    ...
    final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            rectF2.set(f6 - (f9 / 2.0f), f7, f6 + (f9 / 2.0f), fitModeResult2.currentEndHeight + f7);
            ...
            this.shadowPaint.setShadowLayer(f10, (float) ((int) (calculateElevationDxMultiplier * f10)), f11, SHADOW_COLOR);
