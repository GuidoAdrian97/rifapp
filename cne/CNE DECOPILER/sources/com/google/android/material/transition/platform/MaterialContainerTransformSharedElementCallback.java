...
public class MaterialContainerTransformSharedElementCallback extends SharedElementCallback {
    ...
    public void onMapSharedElements(@NonNull List list, @NonNull Map map) {
        View view;
        Activity activity;
        if (!list.isEmpty() && !map.isEmpty() && (view = (View) map.get(list.get(0))) != null && (activity = ContextUtils.getActivity(view.getContext())) != null) {
    ...
    public void onSharedElementStart(@NonNull List list, @NonNull List list2, @NonNull List list3) {
    ...
    public void onSharedElementEnd(@NonNull List list, @NonNull List list2, @NonNull List list3) {
        if (!list2.isEmpty()) {
            int i = R.id.mtrl_motion_snapshot_view;
            if (((View) list2.get(0)).getTag(i) instanceof View) {
                ((View) list2.get(0)).setTag(i, (Object) null);
            }
        }
