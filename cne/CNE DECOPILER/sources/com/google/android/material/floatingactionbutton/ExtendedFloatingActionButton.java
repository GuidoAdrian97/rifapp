...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    static {
        ...
        PADDING_START = new Property(cls, "paddingStart") {
            public void set(@NonNull View view, @NonNull Float f) {
        ...
        PADDING_END = new Property(cls, "paddingEnd") {
            public void set(@NonNull View view, @NonNull Float f) {
    ...
    public class ExtendedFloatingActionButtonBehavior extends CoordinatorLayout.Behavior {
        ...
        public ExtendedFloatingActionButtonBehavior(@NonNull Context context, @Nullable AttributeSet attributeSet) {
            ...
            this.autoHideEnabled = obtainStyledAttributes.getBoolean(R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoHide, AUTO_HIDE_DEFAULT);
        ...
        private static boolean isBottomSheet(@NonNull View view) {
            ...
            return layoutParams instanceof CoordinatorLayout.LayoutParams ? ((CoordinatorLayout.LayoutParams) layoutParams).getBehavior() instanceof BottomSheetBehavior : AUTO_HIDE_DEFAULT;
        }
