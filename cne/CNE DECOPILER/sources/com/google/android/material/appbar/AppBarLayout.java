...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    public class BaseBehavior extends HeaderBehavior {
        ...
        private boolean canScrollChildren(@NonNull CoordinatorLayout coordinatorLayout, @NonNull AppBarLayout appBarLayout, @NonNull View view) {
        ...
        private void updateAccessibilityActions(CoordinatorLayout coordinatorLayout, @NonNull AppBarLayout appBarLayout) {
            ...
            if (findFirstScrollingChild != null && appBarLayout.getTotalScrollRange() != 0 && (((CoordinatorLayout.LayoutParams) findFirstScrollingChild.getLayoutParams()).getBehavior() instanceof ScrollingViewBehavior)) {
                addAccessibilityScrollActions(coordinatorLayout, appBarLayout, findFirstScrollingChild);
            }
        }

        private void addAccessibilityScrollActions(CoordinatorLayout coordinatorLayout, @NonNull AppBarLayout appBarLayout, @NonNull View view) {
            if (getTopBottomOffsetForScrollingSibling() != (-appBarLayout.getTotalScrollRange()) && view.canScrollVertically(1)) {
        ...
        private void addActionToExpand(CoordinatorLayout coordinatorLayout, @NonNull final AppBarLayout appBarLayout, @NonNull AccessibilityNodeInfoCompat.AccessibilityActionCompat accessibilityActionCompat, final boolean z) {
        ...
        private int interpolateOffset(@NonNull AppBarLayout appBarLayout, int i) {
            int abs = Math.abs(i);
            int childCount = appBarLayout.getChildCount();
            int i2 = 0;
            int i3 = 0;
        ...
        private void updateAppBarLayoutDrawableState(@NonNull CoordinatorLayout coordinatorLayout, @NonNull AppBarLayout appBarLayout, int i, int i2, boolean z) {
        ...
        private boolean shouldJumpElevationState(@NonNull CoordinatorLayout coordinatorLayout, @NonNull AppBarLayout appBarLayout) {
    ...
    public class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        /* access modifiers changed from: package-private */
        @Nullable
        public AppBarLayout findFirstDependency(@NonNull List list) {
            int size = list.size();
