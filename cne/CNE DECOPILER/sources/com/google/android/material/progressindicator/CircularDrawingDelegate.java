...
final class CircularDrawingDelegate extends DrawingDelegate {
    ...
    public void adjustCanvas(@NonNull Canvas canvas, @FloatRange float f) {
        ...
        this.displayedCornerRadius = ((float) ((CircularProgressIndicatorSpec) baseProgressIndicatorSpec2).trackCornerRadius) * f;
        this.adjustedRadius = ((float) (((CircularProgressIndicatorSpec) baseProgressIndicatorSpec2).indicatorSize - ((CircularProgressIndicatorSpec) baseProgressIndicatorSpec2).trackThickness)) / 2.0f;
    ...
    public void fillIndicator(@NonNull Canvas canvas, @NonNull Paint paint, @FloatRange float f, @FloatRange float f2, @ColorInt int i) {
        Paint paint2 = paint;
        if (f != f2) {
