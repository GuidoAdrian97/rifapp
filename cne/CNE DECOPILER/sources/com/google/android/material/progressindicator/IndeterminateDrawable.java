...
public final class IndeterminateDrawable extends DrawableWithAnimatedVisibilityChange {
    ...
    IndeterminateDrawable(@NonNull Context context, @NonNull BaseProgressIndicatorSpec baseProgressIndicatorSpec, @NonNull DrawingDelegate drawingDelegate2, @NonNull IndeterminateAnimatorDelegate indeterminateAnimatorDelegate) {
    ...
    @NonNull
    public static IndeterminateDrawable createLinearDrawable(@NonNull Context context, @NonNull LinearProgressIndicatorSpec linearProgressIndicatorSpec) {
    ...
    @NonNull
    public static IndeterminateDrawable createCircularDrawable(@NonNull Context context, @NonNull CircularProgressIndicatorSpec circularProgressIndicatorSpec) {
    ...
    /* access modifiers changed from: package-private */
    public void setAnimatorDelegate(@NonNull IndeterminateAnimatorDelegate indeterminateAnimatorDelegate) {
    ...
    /* access modifiers changed from: package-private */
    public void setDrawingDelegate(@NonNull DrawingDelegate drawingDelegate2) {
