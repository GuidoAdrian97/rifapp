...
public class ChipDrawable extends MaterialShapeDrawable implements Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        ...
        setChipIconVisible(obtainStyledAttributes.getBoolean(R.styleable.Chip_chipIconVisible, DEBUG));
        if (!(attributeSet == null || attributeSet.getAttributeValue(NAMESPACE_APP, "chipIconEnabled") == null || attributeSet.getAttributeValue(NAMESPACE_APP, "chipIconVisible") != null)) {
            setChipIconVisible(obtainStyledAttributes.getBoolean(R.styleable.Chip_chipIconEnabled, DEBUG));
        }
        ...
        setCloseIconVisible(obtainStyledAttributes.getBoolean(R.styleable.Chip_closeIconVisible, DEBUG));
        if (!(attributeSet == null || attributeSet.getAttributeValue(NAMESPACE_APP, "closeIconEnabled") == null || attributeSet.getAttributeValue(NAMESPACE_APP, "closeIconVisible") != null)) {
            setCloseIconVisible(obtainStyledAttributes.getBoolean(R.styleable.Chip_closeIconEnabled, DEBUG));
        }
        ...
        setCheckable(obtainStyledAttributes.getBoolean(R.styleable.Chip_android_checkable, DEBUG));
        setCheckedIconVisible(obtainStyledAttributes.getBoolean(R.styleable.Chip_checkedIconVisible, DEBUG));
        if (!(attributeSet == null || attributeSet.getAttributeValue(NAMESPACE_APP, "checkedIconEnabled") == null || attributeSet.getAttributeValue(NAMESPACE_APP, "checkedIconVisible") != null)) {
            setCheckedIconVisible(obtainStyledAttributes.getBoolean(R.styleable.Chip_checkedIconEnabled, DEBUG));
        }
    ...
    private void drawText(@NonNull Canvas canvas, @NonNull Rect rect) {
        if (this.text != null) {
            ...
            int i = 0;
            boolean z = Math.round(this.textDrawableHelper.getTextWidth(getText().toString())) > Math.round(this.rectF.width()) ? true : DEBUG;
            if (z) {
                i = canvas.save();
    ...
    public boolean setCloseIconState(@NonNull int[] iArr) {
        ...
        return showsCloseIcon() ? onStateChange(getState(), iArr) : DEBUG;
    }
    ...
    public void setChipIconVisible(boolean z) {
        if (this.chipIconVisible != z) {
            ...
            if (showsChipIcon != showsChipIcon2 ? true : DEBUG) {
                if (showsChipIcon2) {
    ...
    public void setCloseIconVisible(boolean z) {
        if (this.closeIconVisible != z) {
            ...
            if (showsCloseIcon != showsCloseIcon2 ? true : DEBUG) {
                if (showsCloseIcon2) {
    ...
    public void setCheckedIconVisible(boolean z) {
        if (this.checkedIconVisible != z) {
            ...
            if (showsCheckedIcon != showsCheckedIcon2 ? true : DEBUG) {
