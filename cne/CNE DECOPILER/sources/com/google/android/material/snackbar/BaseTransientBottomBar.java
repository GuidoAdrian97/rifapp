...
public abstract class BaseTransientBottomBar {
    ...
    @NonNull
    public BaseTransientBottomBar setAnchorView(@Nullable View view2) {
    ...
    @NonNull
    public BaseTransientBottomBar setAnchorView(@IdRes int i) {
    ...
    @NonNull
    public BaseTransientBottomBar setBehavior(Behavior behavior2) {
    ...
    @NonNull
    public BaseTransientBottomBar addCallback(@Nullable BaseCallback baseCallback) {
    ...
    @NonNull
    public BaseTransientBottomBar removeCallback(@Nullable BaseCallback baseCallback) {
        List list;
