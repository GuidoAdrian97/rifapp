...
public final class MaterialDatePicker extends DialogFragment {
    ...
    @NonNull
    static MaterialDatePicker newInstance(@NonNull Builder builder) {
    ...
    public final class Builder {
        ...
        private Builder(DateSelector dateSelector2) {
            this.dateSelector = dateSelector2;
        }

        @NonNull
        @RestrictTo
        public static Builder customDatePicker(@NonNull DateSelector dateSelector2) {
        ...
        @NonNull
        public Builder setCalendarConstraints(CalendarConstraints calendarConstraints2) {
        ...
        private Month createDefaultOpenAt() {
            ...
            if (!this.dateSelector.getSelectedDays().isEmpty()) {
                long longValue = ((Long) this.dateSelector.getSelectedDays().iterator().next()).longValue();
