...
public final class MaterialCalendar extends PickerFragment {
    ...
    @NonNull
    public static MaterialCalendar newInstance(@NonNull DateSelector dateSelector2, @StyleRes int i, @NonNull CalendarConstraints calendarConstraints2) {
    ...
    public boolean addOnSelectionChangedListener(@NonNull OnSelectionChangedListener onSelectionChangedListener) {
