...
public class RangeDateSelector implements DateSelector {
    ...
    public void setSelection(@NonNull Pair pair) {
        Long l;
        ...
        if (obj2 == null) {
            ...
            l = Long.valueOf(UtcDates.canonicalYearMonthDay(((Long) obj2).longValue()));
        }
        this.selectedStartItem = l;
        Object obj3 = pair.second;
        if (obj3 != null) {
            l2 = Long.valueOf(UtcDates.canonicalYearMonthDay(((Long) obj3).longValue()));
        }
    ...
    public View onCreateTextInputView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle, CalendarConstraints calendarConstraints, @NonNull OnSelectionChangedListener onSelectionChangedListener) {
        ...
        final OnSelectionChangedListener onSelectionChangedListener2 = onSelectionChangedListener;
    ...
    /* access modifiers changed from: private */
    public void updateIfValidTextProposal(@NonNull TextInputLayout textInputLayout, @NonNull TextInputLayout textInputLayout2, @NonNull OnSelectionChangedListener onSelectionChangedListener) {
