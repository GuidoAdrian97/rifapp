...
public final class CompositeDateValidator implements CalendarConstraints.DateValidator {
    ...
    public static final Operator ALL_OPERATOR = new Operator() {
        ...
        public boolean isValid(@NonNull List list, long j) {
    ...
    interface Operator {
        ...
        boolean isValid(@NonNull List list, long j);
    }
    ...
    private CompositeDateValidator(@NonNull List list, Operator operator2) {
        this.validators = list;
        this.operator = operator2;
    }

    @NonNull
    public static CalendarConstraints.DateValidator allOf(@NonNull List list) {
        return new CompositeDateValidator(list, ALL_OPERATOR);
    }

    @NonNull
    public static CalendarConstraints.DateValidator anyOf(@NonNull List list) {
