...
class ClockHandView extends View {
    ...
    public interface OnActionUpListener {
        void onActionUp(@FloatRange float f, boolean z);
    }

    public interface OnRotateListener {
        void onRotate(@FloatRange float f, boolean z);
    }
    ...
    public void setHandRotation(@FloatRange float f, boolean z) {
    ...
    public void setHandRotationInternal(@FloatRange float f, boolean z) {
        float f2 = f % 360.0f;
        this.originalDeg = f2;
