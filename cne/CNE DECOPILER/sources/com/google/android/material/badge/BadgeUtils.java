...
public class BadgeUtils {
    ...
    @NonNull
    public static ParcelableSparseArray createParcelableBadgeStates(@NonNull SparseArray sparseArray) {
    ...
    @NonNull
    public static SparseArray createBadgeDrawablesFromSavedStates(Context context, @NonNull ParcelableSparseArray parcelableSparseArray) {
