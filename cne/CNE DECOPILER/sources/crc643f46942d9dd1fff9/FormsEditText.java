...
public class FormsEditText extends FormsEditTextBase {
    ...
    static {
        Runtime.register("Xamarin.Forms.Platform.Android.FormsEditText, Xamarin.Forms.Platform.Android", FormsEditText.class, "n_onKeyPreIme:(ILandroid/view/KeyEvent;)Z:GetOnKeyPreIme_ILandroid_view_KeyEvent_Handler\nn_onSelectionChanged:(II)V:GetOnSelectionChanged_IIHandler\n");
    }
