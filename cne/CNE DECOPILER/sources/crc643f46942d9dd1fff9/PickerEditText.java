...
public class PickerEditText extends FormsEditTextBase {
    ...
    static {
        Runtime.register("Xamarin.Forms.Platform.Android.PickerEditText, Xamarin.Forms.Platform.Android", PickerEditText.class, "n_onTouchEvent:(Landroid/view/MotionEvent;)Z:GetOnTouchEvent_Landroid_view_MotionEvent_Handler\nn_onFocusChanged:(ZILandroid/graphics/Rect;)V:GetOnFocusChanged_ZILandroid_graphics_Rect_Handler\n");
    }
