...
public class TypefaceCompatApi29Impl extends TypefaceCompatBaseImpl {
    ...
    public android.graphics.Typeface createFromFontInfo(android.content.Context r11, android.os.CancellationSignal r12, androidx.core.provider.FontsContractCompat.FontInfo[] r13, int r14) {
        ...
        L_0x0009:
            ...
            android.net.Uri r7 = r6.getUri()     // Catch:{ IOException -> 0x005c }
        ...
        L_0x0020:
            ...
            int r9 = r6.getWeight()     // Catch:{ all -> 0x0052 }
            android.graphics.fonts.Font$Builder r8 = r8.setWeight(r9)     // Catch:{ all -> 0x0052 }
            boolean r9 = r6.isItalic()     // Catch:{ all -> 0x0052 }
        ...
        L_0x0035:
            ...
            int r6 = r6.getTtcIndex()     // Catch:{ all -> 0x0052 }
