            ...
            while (i3 < fArr3.length) {
                if (c3 != 'A') {
                    if (c3 == 'C') {
                            ...
                            if (c3 != 'q') {
                                if (c3 == 'v') {
                                    ...
                                    if (c3 == 'M') {
                                        ...
                                        int i21 = i3 + 2;
                                        int i22 = i3 + 3;
                                        path.cubicTo(f17, f26, fArr3[i19], fArr3[i20], fArr3[i21], fArr3[i22]);
                                        f4 = fArr3[i19];
                                        f3 = fArr3[i20];
                                        f17 = fArr3[i21];
                                        f18 = fArr3[i22];
                                        ...
                                        int i23 = i3 + 0;
                                        int i24 = i3 + 1;
                                        path2.quadTo(f17, f18, fArr3[i23], fArr3[i24]);
                                        float f27 = fArr3[i23];
                                        float f28 = fArr3[i24];
                                        i2 = i3;
                                        f14 = f18;
                                        ...
                                        int i25 = i3 + 0;
                                        int i26 = i3 + 1;
                                        path2.rLineTo(fArr3[i25], fArr3[i26]);
                                        f17 += fArr3[i25];
                                        f6 = fArr3[i26];
                                    } else if (c3 == 'm') {
                                        ...
                                        int i29 = i3 + 2;
                                        int i30 = i3 + 3;
                                        path.rCubicTo(f8, f7, fArr3[i27], fArr3[i28], fArr3[i29], fArr3[i30]);
                                        f4 = fArr3[i27] + f17;
                                        f3 = fArr3[i28] + f18;
                                        f17 += fArr3[i29];
                                        f5 = fArr3[i30];
                                        ...
                                        int i31 = i3 + 0;
                                        int i32 = i3 + 1;
                                        path2.rQuadTo(f9, f10, fArr3[i31], fArr3[i32]);
                                        float f32 = f9 + f17;
                                        float f33 = f10 + f18;
                                        f17 += fArr3[i31];
                                        f18 += fArr3[i32];
                                    ...
                                    int i33 = i3 + 0;
                                    int i34 = i3 + 1;
                                    path2.lineTo(fArr3[i33], fArr3[i34]);
                                    f17 = fArr3[i33];
                                    f18 = fArr3[i34];
                                }
                                f18 += f6;
                                ...
                                int i37 = i3 + 2;
                                int i38 = i3 + 3;
                                path2.rQuadTo(fArr3[i35], fArr3[i36], fArr3[i37], fArr3[i38]);
                                f4 = fArr3[i35] + f17;
                                f3 = fArr3[i36] + f18;
                                f17 += fArr3[i37];
                                f5 = fArr3[i38];
                        ...
                        int i41 = i3 + 6;
                        i2 = i3;
                        drawArc(path, f17, f18, fArr3[i40] + f17, fArr3[i41] + f18, fArr3[i3 + 0], fArr3[i3 + 1], fArr3[i3 + 2], fArr3[i3 + 3] != 0.0f, fArr3[i3 + 4] != 0.0f);
                        f = f17 + fArr3[i40];
                        f2 = f18 + fArr3[i41];
                    }
                    i3 = i2 + i;
                    ...
                    int i42 = i2 + 5;
                    int i43 = i2 + 6;
                    drawArc(path, f17, f18, fArr3[i42], fArr3[i43], fArr3[i2 + 0], fArr3[i2 + 1], fArr3[i2 + 2], fArr3[i2 + 3] != 0.0f, fArr3[i2 + 4] != 0.0f);
                    f = fArr3[i42];
                    f2 = fArr3[i43];
                }
                f14 = f18;
