    ...
    public final void restoreState(@NonNull Parcelable parcelable) {
        ...
        for (String next : bundle.keySet()) {
            if (isValidKey(next, "f#")) {
                this.mFragments.put(parseIdFromKey(next, "f#"), this.mFragmentManager.getFragment(bundle, next));
            } else if (isValidKey(next, "s#")) {
                long parseIdFromKey = parseIdFromKey(next, "s#");
