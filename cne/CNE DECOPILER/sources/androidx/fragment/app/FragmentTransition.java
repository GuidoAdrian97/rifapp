...
abstract class FragmentTransition {
    ...
    private static void configureTransitionsReordered(ViewGroup viewGroup, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap arrayMap, Callback callback) {
        Object obj;
    ...
    private static void configureTransitionsOrdered(ViewGroup viewGroup, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap arrayMap, Callback callback) {
        Object obj;
        ViewGroup viewGroup2 = viewGroup;
        FragmentContainerTransition fragmentContainerTransition2 = fragmentContainerTransition;
        View view2 = view;
    ...
    static String findKeyForValue(ArrayMap arrayMap, String str) {
