...
public final class NavDeepLinkBuilder {
    ...
    @NonNull
    public NavDeepLinkBuilder setComponentName(@NonNull Class cls) {
    ...
    class PermissiveNavigatorProvider extends NavigatorProvider {
        private final Navigator mDestNavigator = new Navigator() {
