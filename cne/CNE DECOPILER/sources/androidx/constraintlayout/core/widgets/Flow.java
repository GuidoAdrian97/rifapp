        ...
        if (i10 != 0) {
            ...
            if (i4 > 0 && z3) {
                for (int i19 = 0; i19 < size; i19++) {
                    WidgetsList widgetsList2 = (WidgetsList) this.mChainList.get(i19);
                    if (i2 == 0) {
            ...
            while (i24 < size) {
                WidgetsList widgetsList3 = (WidgetsList) this.mChainList.get(i24);
                if (i2 == 0) {
                    if (i24 < size - 1) {
                        constraintAnchor2 = ((WidgetsList) this.mChainList.get(i24 + 1)).biggest.mTop;
                        i7 = 0;
                    } else {
                    ...
                    i5 = i24;
                    if (i5 < size - 1) {
                        constraintAnchor = ((WidgetsList) this.mChainList.get(i5 + 1)).biggest.mLeft;
                        i6 = 0;
                    } else {
