    ...
    public void addCycleValues(HashMap hashMap) {
        ...
        for (String str : hashMap.keySet()) {
            if (str.startsWith("CUSTOM")) {
                CustomVariable customVariable = (CustomVariable) this.mCustom.get(str.substring(7));
                if (!(customVariable == null || customVariable.getType() != 901 || (keyCycleOscillator2 = (KeyCycleOscillator) hashMap2.get(str)) == null)) {
                ...
                if (!Float.isNaN(value) && (keyCycleOscillator = (KeyCycleOscillator) hashMap2.get(str)) != null) {
