        ...
        if (this.mConstraintWidget != null) {
            ...
            if (hashMap != null) {
                for (String str : hashMap.keySet()) {
                    this.mConstraintWidget.frame.setCustomAttribute(str, 902, ((Integer) this.mCustomColors.get(str)).intValue());
                }
            }
            HashMap hashMap2 = this.mCustomFloats;
            if (hashMap2 != null) {
                for (String str2 : hashMap2.keySet()) {
                    this.mConstraintWidget.frame.setCustomAttribute(str2, 901, ((Float) this.mCustomFloats.get(str2)).floatValue());
                }
            }
        }
    }
