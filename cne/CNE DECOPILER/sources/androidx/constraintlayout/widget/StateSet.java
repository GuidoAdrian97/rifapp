...
public class StateSet {
    ...
    private void load(android.content.Context r10, org.xmlpull.v1.XmlPullParser r11) {
        ...
        L_0x0089:
            ...
            android.util.SparseArray r1 = r9.mStateList     // Catch:{ XmlPullParserException -> 0x00a3, IOException -> 0x009e }
    ...
    public int updateConstraints(int i, int i2, float f, float f2) {
        ...
        if (i == i2) {
            ...
            if ((this.mCurrentConstraintNumber == -1 || !((Variant) state.mVariants.get(i)).match(f, f2)) && i != (findMatch = state.findMatch(f, f2))) {
