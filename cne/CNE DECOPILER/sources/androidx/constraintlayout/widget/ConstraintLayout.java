...
public class ConstraintLayout extends ViewGroup {
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (constraintWidget2 != null) {
                if (constraintWidget.getVisibility() == 8 && !constraintWidget.isInPlaceholder()) {
                    ...
                    boolean z3 = dimensionBehaviour == dimensionBehaviour3 ? ConstraintLayout.USE_CONSTRAINTS_HELPER : false;
                    boolean z4 = dimensionBehaviour2 == dimensionBehaviour3 ? ConstraintLayout.USE_CONSTRAINTS_HELPER : false;
                    ConstraintWidget.DimensionBehaviour dimensionBehaviour4 = ConstraintWidget.DimensionBehaviour.MATCH_PARENT;
                    boolean z5 = (dimensionBehaviour2 == dimensionBehaviour4 || dimensionBehaviour2 == ConstraintWidget.DimensionBehaviour.FIXED) ? ConstraintLayout.USE_CONSTRAINTS_HELPER : false;
                    boolean z6 = (dimensionBehaviour == dimensionBehaviour4 || dimensionBehaviour == ConstraintWidget.DimensionBehaviour.FIXED) ? ConstraintLayout.USE_CONSTRAINTS_HELPER : false;
                    ...
                    if (view != null) {
                        ...
                        if (i16 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i16 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z3 || constraintWidget2.mMatchConstraintDefaultWidth != 0 || !z4 || constraintWidget2.mMatchConstraintDefaultHeight != 0) {
                        ...
                        boolean z9 = i4 != i6 ? ConstraintLayout.USE_CONSTRAINTS_HELPER : false;
                        measure2.measuredNeedsSolverPass = (i3 == measure2.horizontalDimension && i5 == measure2.verticalDimension) ? false : ConstraintLayout.USE_CONSTRAINTS_HELPER;
    ...
    /* access modifiers changed from: protected */
    public void applyConstraintsFromLayoutParams(boolean z, View view, ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray sparseArray) {
        int i;
        ...
        if (layoutParams2.isGuideline) {
            ...
            if (i10 != -1) {
                ...
                if (i6 != -1) {
                    ConstraintWidget constraintWidget9 = (ConstraintWidget) sparseArray2.get(i6);
                ...
                } else if (!(i7 == -1 || (constraintWidget4 = (ConstraintWidget) sparseArray2.get(i7)) == null)) {
                ...
                if (i11 != -1) {
                    ConstraintWidget constraintWidget10 = (ConstraintWidget) sparseArray2.get(i11);
                    ...
                    if (!(i12 == -1 || (constraintWidget3 = (ConstraintWidget) sparseArray2.get(i12)) == null)) {
                ...
                if (i13 != -1) {
                    ConstraintWidget constraintWidget11 = (ConstraintWidget) sparseArray2.get(i13);
                    ...
                    if (!(i14 == -1 || (constraintWidget2 = (ConstraintWidget) sparseArray2.get(i14)) == null)) {
    ...
    private void setWidgetBaseline(ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray sparseArray, int i, ConstraintAnchor.Type type) {
        ...
        if (constraintWidget2 != null && view != null && (view.getLayoutParams() instanceof LayoutParams)) {
            ...
            constraintWidget.getAnchor(type2).connect(constraintWidget2.getAnchor(type), layoutParams.baselineMargin, layoutParams.goneBaselineMargin, USE_CONSTRAINTS_HELPER);
