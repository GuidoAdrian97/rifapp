...
public class ConstraintSet {
    ...
    /* access modifiers changed from: private */
    public HashMap mConstraints = new HashMap();
            ...
            if (constraint.mDelta != null) {
                if (constraint.mTargetString != null) {
                    for (Integer intValue : this.mConstraints.keySet()) {
                        Constraint constraint2 = getConstraint(intValue.intValue());
    ...
    public void applyCustomAttributes(ConstraintLayout constraintLayout) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (!this.mConstraints.containsKey(Integer.valueOf(id))) {
                ...
                throw new RuntimeException("All children of ConstraintLayout must have ids to use ConstraintSet");
            } else if (this.mConstraints.containsKey(Integer.valueOf(id)) && (constraint = (Constraint) this.mConstraints.get(Integer.valueOf(id))) != null) {
                ConstraintAttribute.setAttributes(childAt, constraint.mCustomConstraints);
            }
        }
    }

    public void applyToHelper(ConstraintHelper constraintHelper, ConstraintWidget constraintWidget, ConstraintLayout.LayoutParams layoutParams, SparseArray sparseArray) {
        Constraint constraint;
    ...
    public void load(android.content.Context r10, org.xmlpull.v1.XmlPullParser r11) {
        ...
        L_0x004e:
            ...
            goto L_0x01cb
        L_0x0058:
            java.util.HashMap r0 = r9.mConstraints     // Catch:{ XmlPullParserException -> 0x01d6, IOException -> 0x01d1 }
        ...
        L_0x00e0:
            ...
            java.util.HashMap r0 = r2.mCustomConstraints     // Catch:{ XmlPullParserException -> 0x01d6, IOException -> 0x01d1 }
        ...
        private void writeDimension(String str, int i, int i2, float f, int i3, int i4, boolean z) {
            if (i == 0) {
                if (i4 == -1 && i3 == -1) {
                    ...
                    Writer writer4 = this.writer;
                    writer4.write("       " + str + ": {'spread' ," + i3 + ", " + i4 + "}\n");
                } else if (i2 == 1) {
                    Writer writer5 = this.writer;
                    writer5.write("       " + str + ": {'wrap' ," + i3 + ", " + i4 + "}\n");
                } else if (i2 == 2) {
                    Writer writer6 = this.writer;
                    writer6.write("       " + str + ": {'" + f + "'% ," + i3 + ", " + i4 + "}\n");
                }
            } else if (i == -2) {
                Writer writer7 = this.writer;
                writer7.write("       " + str + ": 'wrap'\n");
            } else if (i == -1) {
                Writer writer8 = this.writer;
                writer8.write("       " + str + ": 'parent'\n");
            } else {
