...
public class MotionScene {
        ...
        for (Transition transition2 : transitionsWithState) {
            if (!transition2.mDisable && transition2.mTouchResponse != null) {
                ...
                if ((touchRegion == null || motionEvent == null || touchRegion.contains(motionEvent.getX(), motionEvent.getY())) && ((limitBoundsTo = transition2.mTouchResponse.getLimitBoundsTo(this.mMotionLayout, rectF)) == null || motionEvent == null || limitBoundsTo.contains(motionEvent.getX(), motionEvent.getY()))) {
                    float dot = transition2.mTouchResponse.dot(f3, f4);
                    ...
                    float f6 = dot * (transition2.mConstraintSetEnd == i2 ? -1.0f : 1.1f);
                    if (f6 > f5) {
        ...
        while (it.hasNext()) {
            ...
            if (transition2.mAutoTransition != 0 && ((transition = this.mCurrentTransition) != transition2 || !transition.isTransitionFlag(2))) {
                if (i == transition2.mConstraintSetStart && (transition2.mAutoTransition == 4 || transition2.mAutoTransition == 2)) {
                    ...
                    return true;
                } else if (i == transition2.mConstraintSetEnd && (transition2.mAutoTransition == 3 || transition2.mAutoTransition == 1)) {
    ...
    public class Transition {
        ...
        /* access modifiers changed from: private */
        public ArrayList mKeyFramesList = new ArrayList();
        private int mLayoutDuringTransition = 0;
        /* access modifiers changed from: private */
        public final MotionScene mMotionScene;
        /* access modifiers changed from: private */
        public ArrayList mOnClicks = new ArrayList();
        /* access modifiers changed from: private */
    ...
    private void load(android.content.Context r9, int r10) {
        ...
        L_0x010f:
            ...
            goto L_0x0165
        L_0x011c:
            java.util.ArrayList r1 = r8.mTransitionList     // Catch:{ XmlPullParserException -> 0x0170, IOException -> 0x016b }
        ...
        L_0x0143:
            ...
            goto L_0x0157
        L_0x0152:
            java.util.ArrayList r1 = r8.mAbstractTransitionList     // Catch:{ XmlPullParserException -> 0x0170, IOException -> 0x016b }
            r1.add(r2)     // Catch:{ XmlPullParserException -> 0x0170, IOException -> 0x016b }
        L_0x0157:
            java.util.ArrayList r1 = r8.mTransitionList     // Catch:{ XmlPullParserException -> 0x0170, IOException -> 0x016b }
    ...
    private int parseConstraintSet(android.content.Context r14, org.xmlpull.v1.XmlPullParser r15) {
        ...
        L_0x0064:
            ...
            java.util.HashMap r7 = r13.mConstraintSetIdMap
        ...
        L_0x0095:
            ...
            r14.put(r5, r6)
        L_0x009f:
            android.util.SparseArray r14 = r13.mConstraintSetMap
            r14.put(r5, r0)
        L_0x00a4:
            return r5
        */
