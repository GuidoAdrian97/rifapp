    ...
    public void addCycleValues(HashMap hashMap) {
        ...
        for (String str : hashMap.keySet()) {
            if (str.startsWith("CUSTOM")) {
                ...
                if (!(constraintAttribute == null || constraintAttribute.getType() != ConstraintAttribute.AttributeType.FLOAT_TYPE || (viewOscillator2 = (ViewOscillator) hashMap2.get(str)) == null)) {
                ...
                if (!Float.isNaN(value) && (viewOscillator = (ViewOscillator) hashMap2.get(str)) != null) {
