...
public class DesignTool {
    ...
    private static void Connect(int i, ConstraintSet constraintSet, View view, HashMap hashMap, int i2, int i3) {
    ...
    private static void SetBias(ConstraintSet constraintSet, View view, HashMap hashMap, int i) {
    ...
    private static void SetDimensions(int i, ConstraintSet constraintSet, View view, HashMap hashMap, int i2) {
    ...
    private static void SetAbsolutePositions(int i, ConstraintSet constraintSet, View view, HashMap hashMap) {
    ...
    public float getKeyFramePosition(Object obj, int i, float f, float f2) {
        ...
        if ((obj instanceof View) && (motionController = (MotionController) this.mMotionLayout.mFrameArrayList.get((View) obj)) != null) {
