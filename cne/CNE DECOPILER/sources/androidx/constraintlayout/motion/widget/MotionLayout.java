...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    private ArrayList mDecoratorsHelpers = null;
    ...
    int mEndWrapHeight;
    int mEndWrapWidth;
    HashMap mFrameArrayList = new HashMap();
    ...
    private ArrayList mOnHideHelpers = null;
    private ArrayList mOnShowHelpers = null;
    float mPostInterpolationPosition;
    HashMap mPreRotate = new HashMap();
    /* access modifiers changed from: private */
    ...
    ArrayList mTransitionCompleted = new ArrayList();
    ...
    private CopyOnWriteArrayList mTransitionListeners = null;
    ...
    class Model {
        ...
        public void measure(int i, int i2) {
            ...
            if (motionLayout2.mCurrentState == motionLayout2.getStartState()) {
                ...
                motionLayout3.resolveSystem(constraintWidgetContainer, optimizationLevel, (constraintSet == null || constraintSet.mRotate == 0) ? i : i2, (constraintSet == null || constraintSet.mRotate == 0) ? i2 : i);
                ConstraintSet constraintSet2 = this.mStart;
                if (constraintSet2 != null) {
                    MotionLayout motionLayout4 = MotionLayout.this;
                    ConstraintWidgetContainer constraintWidgetContainer2 = this.mLayoutStart;
                    int i3 = constraintSet2.mRotate;
                    motionLayout4.resolveSystem(constraintWidgetContainer2, optimizationLevel, i3 == 0 ? i : i2, i3 == 0 ? i2 : i);
                }
            } else {
                ...
                if (constraintSet3 != null) {
                    ...
                    motionLayout5.resolveSystem(constraintWidgetContainer3, optimizationLevel, i4 == 0 ? i : i2, i4 == 0 ? i2 : i);
                }
                MotionLayout motionLayout6 = MotionLayout.this;
                ConstraintWidgetContainer constraintWidgetContainer4 = this.mLayoutEnd;
                ConstraintSet constraintSet4 = this.mEnd;
                motionLayout6.resolveSystem(constraintWidgetContainer4, optimizationLevel, (constraintSet4 == null || constraintSet4.mRotate == 0) ? i : i2, (constraintSet4 == null || constraintSet4.mRotate == 0) ? i2 : i);
            }
            if (((MotionLayout.this.getParent() instanceof MotionLayout) && mode == 1073741824 && mode2 == 1073741824) ? false : true) {
                ...
                if (motionLayout7.mCurrentState == motionLayout7.getStartState()) {
                    ...
                    int i5 = this.mEnd.mRotate;
                    motionLayout8.resolveSystem(constraintWidgetContainer5, optimizationLevel, i5 == 0 ? i : i2, i5 == 0 ? i2 : i);
                    ...
                    if (constraintSet5 != null) {
                        ...
                        int i6 = constraintSet5.mRotate;
                        motionLayout9.resolveSystem(constraintWidgetContainer6, optimizationLevel, i6 == 0 ? i : i2, i6 == 0 ? i2 : i);
                    }
                } else {
                    ...
                    if (constraintSet6 != null) {
                        ...
                        int i7 = constraintSet6.mRotate;
                        motionLayout10.resolveSystem(constraintWidgetContainer7, optimizationLevel, i7 == 0 ? i : i2, i7 == 0 ? i2 : i);
                    }
                    MotionLayout motionLayout11 = MotionLayout.this;
                    ConstraintWidgetContainer constraintWidgetContainer8 = this.mLayoutEnd;
                    int i8 = this.mEnd.mRotate;
                    motionLayout11.resolveSystem(constraintWidgetContainer8, optimizationLevel, i8 == 0 ? i : i2, i8 == 0 ? i2 : i);
                }
            ...
            if (i11 == Integer.MIN_VALUE || i11 == 0) {
                i9 = (int) (((float) i9) + (motionLayout13.mPostInterpolationPosition * ((float) (motionLayout13.mEndWrapWidth - i9))));
            }
            int i12 = i9;
            int i13 = motionLayout13.mHeightMeasureMode;
            if (i13 == Integer.MIN_VALUE || i13 == 0) {
                i10 = (int) (((float) i10) + (motionLayout13.mPostInterpolationPosition * ((float) (motionLayout13.mEndWrapHeight - i10))));
            }
            MotionLayout.this.resolveMeasuredDimension(i, i2, i12, i10, this.mLayoutStart.isWidthMeasuredTooSmall() || this.mLayoutEnd.isWidthMeasuredTooSmall(), this.mLayoutStart.isHeightMeasuredTooSmall() || this.mLayoutEnd.isHeightMeasuredTooSmall());
        }
        ...
        public void build() {
            /*
                ...
                java.util.HashMap r2 = r2.mFrameArrayList
                r2.clear()
            ...
            L_0x0017:
                ...
                java.util.HashMap r8 = r8.mFrameArrayList
                r8.put(r6, r7)
                int r5 = r5 + 1
                goto L_0x0017
            L_0x0037:
            ...
            L_0x0038:
                ...
                java.util.HashMap r7 = r7.mFrameArrayList
            ...
            L_0x00b2:
                ...
                if (r7 == 0) goto L_0x00e1
                androidx.constraintlayout.motion.widget.MotionLayout r7 = androidx.constraintlayout.motion.widget.MotionLayout.this
                java.util.HashMap r7 = r7.mPreRotate
                java.lang.Object r7 = r7.get(r6)
                r8 = r7
    ...
    public void evaluate(boolean r24) {
        ...
        L_0x0172:
            ...
            java.util.HashMap r11 = r0.mFrameArrayList
