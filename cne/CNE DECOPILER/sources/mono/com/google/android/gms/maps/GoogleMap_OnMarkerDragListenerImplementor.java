...
public class GoogleMap_OnMarkerDragListenerImplementor implements IGCUserPeer, GoogleMap.OnMarkerDragListener {
    ...
    static {
        Runtime.register("Android.Gms.Maps.GoogleMap+IOnMarkerDragListenerImplementor, Xamarin.GooglePlayServices.Maps", GoogleMap_OnMarkerDragListenerImplementor.class, __md_methods);
    }
