...
public class GoogleMap_OnPolygonClickListenerImplementor implements IGCUserPeer, GoogleMap.OnPolygonClickListener {
    ...
    static {
        Runtime.register("Android.Gms.Maps.GoogleMap+IOnPolygonClickListenerImplementor, Xamarin.GooglePlayServices.Maps", GoogleMap_OnPolygonClickListenerImplementor.class, __md_methods);
    }
