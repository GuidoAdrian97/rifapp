...
public class GoogleMap_OnMyLocationChangeListenerImplementor implements IGCUserPeer, GoogleMap.OnMyLocationChangeListener {
    ...
    static {
        Runtime.register("Android.Gms.Maps.GoogleMap+IOnMyLocationChangeListenerImplementor, Xamarin.GooglePlayServices.Maps", GoogleMap_OnMyLocationChangeListenerImplementor.class, __md_methods);
    }
