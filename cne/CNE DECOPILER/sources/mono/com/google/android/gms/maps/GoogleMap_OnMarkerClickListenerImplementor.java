...
public class GoogleMap_OnMarkerClickListenerImplementor implements IGCUserPeer, GoogleMap.OnMarkerClickListener {
    ...
    static {
        Runtime.register("Android.Gms.Maps.GoogleMap+IOnMarkerClickListenerImplementor, Xamarin.GooglePlayServices.Maps", GoogleMap_OnMarkerClickListenerImplementor.class, __md_methods);
    }
