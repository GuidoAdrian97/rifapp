...
public class Runtime {
    ...
    public static native void initInternal(String str, String[] strArr, String str2, String[] strArr2, int i, ClassLoader classLoader, String[] strArr3, int i2, boolean z, boolean z2);
